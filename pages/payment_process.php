...
<div class="container p-5 card" style="max-width: 600px; margin-top: 100px; max-height: 600px;"> 
    <h2 class="mb-4">Process Payment (Booking #<?php echo $booking_id; ?>)</h2>
    <div class="mb-3"style="gap:10px; display:flex; flex-direction:column;">
    ...
    <div class="mb-4">
        ...
        <input type="number" name="amount_paid" step="0.01" class="form-control"><br><br>
        ...
        <button type="submit" name="pay" class="btn btn-success form-control">Save Payment</button>
